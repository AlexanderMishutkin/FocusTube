...
Polished copy for Chrome Web Store, Microsoft Edge Add-ons, and Firefox Add-ons listings.

## Short Description

Reduce distracting Shorts, Reels, TikTok, Facebook, and LinkedIn feed surfaces with local-only browser controls.
...
- Manage settings locally from the options page.

## Privacy Statement

FocusTube is designed to run locally in your browser. It does not sell user data or transmit settings, browsing activity, or extension statistics to a project-controlled server. Settings, timer state, and simple blocked-count statistics are stored locally using browser storage. The extension does not include analytics scripts or telemetry.

## Support / Bug Reports

Report bugs or compatibility issues on GitHub: https://github.com/malekwael229/FocusTube/issues

Helpful reports include the browser, extension version, website affected, blocking mode, expected behavior, actual behavior, and screenshots or screen recordings when possible.
